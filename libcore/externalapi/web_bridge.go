// Copied from sing-box service/api (v1.14.0-rc.1). Keep in sync when upgrading sing-box.
...
// client transports.
func newHTTPHandler(logger log.ContextLogger, grpcServer *grpc.Server, options Options) http.Handler {
