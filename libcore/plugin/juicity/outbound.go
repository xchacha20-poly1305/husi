...
func (o *Outbound) MultiplexEnabled() bool {
	return true
}

func (o *Outbound) SetKeepIdleConnections(keep bool) {
	o.client.SetKeepIdleConnections(keep)
}

func (o *Outbound) CloseIdleConnections() {
