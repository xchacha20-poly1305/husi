...
require (
	...
	github.com/sagernet/sing-box v1.13.0-beta.3
...
require (
	...
	github.com/sagernet/quic-go v0.59.0-sing-box-mod.1 // indirect
	github.com/sagernet/sing-mux v0.3.3 // indirect
	github.com/sagernet/sing-quic v0.6.0-beta.9 // indirect
