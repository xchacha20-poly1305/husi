...
require (
	...
	github.com/sagernet/sing-box v1.9.0-beta.7 // Bump core version here.
...
replace github.com/sagernet/sing-box => github.com/xchacha20-poly1305/sing-box v1.9.0-beta.7
