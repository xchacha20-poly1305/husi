...
import fr.husi.bg.VpnService
import fr.husi.bg.VpnService.Companion.PRIVATE_VLAN4_ROUTER
import fr.husi.bg.VpnService.Companion.PRIVATE_VLAN6_ROUTER
                ...
                Inbound_TunOptions().apply {
                    ...
                    when (networkStrategy) {
                        SingBoxOptions.STRATEGY_IPV4_ONLY -> {
                            address = mutableListOf(VpnService.PRIVATE_VLAN4_CLIENT + "/28")
                        }

                        SingBoxOptions.STRATEGY_IPV6_ONLY -> {
                            address = mutableListOf(VpnService.PRIVATE_VLAN6_CLIENT + "/126")
                        }
                ...
                if (proxyEntity.needExternal()) { // external outbound
                    ...
                    currentOutbound = when (bean) {
                        ...
                        is ProxySetBean -> {
                            ...
                            buildSingBoxOutboundProxySetBean(bean, tags).asMap()
                        }
            ...
            val builtInDNSRule = localDNSPort?.let {
                Rule_Logical().also {
                    ...
                    it.rules = mutableListOf(
                        ...
                        Rule_Default().apply {
                            ip_cidr = mutableListOf(PRIVATE_VLAN4_ROUTER, PRIVATE_VLAN6_ROUTER)
                        },
                    )
