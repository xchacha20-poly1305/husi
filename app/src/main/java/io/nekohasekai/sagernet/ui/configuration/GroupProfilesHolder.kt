...
private fun ProxyCardPreview() {
    MaterialTheme {
        Column(
            modifier = Modifier.padding(16.dp),
            verticalArrangement = Arrangement.spacedBy(8.dp),
        ) {
            // Selected card with available status
            val selectedEntity = ProxyEntity().apply {
                id = 1
                ...
                socksBean = SOCKSBean().apply {
                    name = "HK Server 01"
                    serverAddress = "hk.example.com"
                    serverPort = 1080
                }
            }
            ProxyCard(
                profile = ProfileItem(selectedEntity, isSelected = true, started = false),
                select = {}, edit = {}, showQR = {},
                onCopySuccess = {}, exportToFile = { _, _ -> },
                showAddress = true, blurAddress = false, showTraffic = true,
            )

            // Unselected card with unavailable status
            val unavailableEntity = ProxyEntity().apply {
                id = 2
                type = ProxyEntity.TYPE_VMESS
                status = ProxyEntity.STATUS_UNAVAILABLE
                error = "Connection timeout"
                vmessBean = VMessBean().apply {
                    name = "US Server 02"
            ...
            ProxyCard(
                profile = ProfileItem(unavailableEntity, isSelected = false, started = false),
                select = {}, edit = {}, showQR = {},
                onCopySuccess = {}, exportToFile = { _, _ -> },
                showAddress = true, blurAddress = false, showTraffic = true,
            )

            // Card with blurred address
            val blurredEntity = ProxyEntity().apply {
                id = 3
                ...
                trojanBean = TrojanBean().apply {
                    name = "SG Server 03"
                    serverAddress = "singapore.example.com"
                    serverPort = 443
                }
            }
            ProxyCard(
                profile = ProfileItem(blurredEntity, isSelected = false, started = false),
                select = {}, edit = {}, showQR = {},
                onCopySuccess = {}, exportToFile = { _, _ -> },
                showAddress = true, blurAddress = true, showTraffic = true,
            )

            val noTrafficEntity = ProxyEntity().apply {
                id = 4
            ...
            ProxyCard(
                profile = ProfileItem(noTrafficEntity, isSelected = false, started = false),
                select = {}, edit = {}, showQR = {},
                onCopySuccess = {}, exportToFile = { _, _ -> },
                showAddress = false, blurAddress = false, showTraffic = false,
            )
        }
    }
}
