            ...
            LazyColumn(
                ...
                item(Key.NIGHT_THEME, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(context.getString(nightString(it)))
                        },
                    )
                }
                item(Key.APP_LANGUAGE, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(context.getString(getLanguageDisplayName(it)))
                        },
                    )
                }
                item(Key.SERVICE_MODE, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(context.getString(serviceModeText(it)))
                        },
                    )
                }
                ...
                item(Key.TUN_IMPLEMENTATION, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(tunImplText(it))
                        },
                    )
                }
                ...
                item(Key.SPEED_INTERVAL, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(speedIntervalText(it))
                        },
                    )
                }
                ...
                item(Key.LOG_LEVEL, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(logLevelString(it))
                        },
                    )
                }
                ...
                item(Key.NETWORK_STRATEGY, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(context.getString(networkStrategyTextRes(it)))
                        },
                    )
                }
                ...
                item(Key.RULES_PROVIDER, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(rulesProviderText(it))
                        },
                    )
                }
                ...
                item(Key.PROVIDER_HYSTERIA2, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(pluginProviderText(it))
                        },
                    )
                }
                ...
                item(Key.CERT_PROVIDER, PreferenceType.LIST_PREFERENCE) {
                    ...
                    ListPreference(
                        ...
                        item = ListPreferenceMenuItem {
                            AnnotatedString(context.getString(certProviderTextRes(it)))
                        },
                    )
                }
